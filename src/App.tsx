    ...
    return (
      <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center p-6 text-center font-sans">
        <div className="bg-white p-8 rounded-3xl shadow-xl max-w-md w-full border border-gray-100">
          ...
          <h1 className="text-2xl font-bold text-gray-800 mb-4">欢迎使用华意记账</h1>
          ...
          <div className="relative flex items-center py-2 mb-6">
            ...
            <span className="flex-shrink-0 mx-4 text-gray-400 text-xs">或使用其他方式</span>
            <div className="flex-grow border-t border-gray-200"></div>
          </div>

          <button 
            onClick={handleLogin}
            className="flex items-center justify-center gap-3 w-full py-3.5 bg-white border border-gray-200 text-gray-700 rounded-xl font-bold text-sm hover:bg-gray-50 transition-colors mb-3"
          >
